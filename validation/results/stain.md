...
`src.filters.color_deconvolution` | family: Special | 2026-08-21T12:46:49
...
|---|---|---|---|---|
| `cctv/brightest.jpg` | `defaults` | 22.6 | [362, 640] uint8 mean 124.71 | ok |
...
| `cctv/brightest.jpg` | `invert=True` | 22.3 | [362, 640] uint8 mean 130.29 | ok |
| `cctv/darkest.jpg` | `defaults` | 22.4 | [362, 640] uint8 mean 62.64 | ok |
| `cctv/darkest.jpg` | `preset=blue_black_ink` | 22.5 | [362, 640] uint8 mean 242.45 | ok |
| `cctv/darkest.jpg` | `preset=brighten` | 0.0 | - | refused: ValueError: Unknown preset 'brighten'. Available: blue_black_ink, h_dab |
| `cctv/darkest.jpg` | `invert=True` | 23.0 | [362, 640] uint8 mean 192.36 | ok |
| `cctv/event_fall.jpg` | `defaults` | 22.7 | [362, 640] uint8 mean 79.51 | ok |
| `cctv/event_fall.jpg` | `preset=blue_black_ink` | 22.5 | [362, 640] uint8 mean 234.4 | ok |
| `cctv/event_fall.jpg` | `preset=brighten` | 0.0 | - | refused: ValueError: Unknown preset 'brighten'. Available: blue_black_ink, h_dab |
| `cctv/event_fall.jpg` | `invert=True` | 22.5 | [362, 640] uint8 mean 175.49 | ok |
| `cctv/event_optflow.jpg` | `defaults` | 22.3 | [362, 640] uint8 mean 75.93 | ok |
| `cctv/event_optflow.jpg` | `preset=blue_black_ink` | 22.5 | [362, 640] uint8 mean 236.37 | ok |
| `cctv/event_optflow.jpg` | `preset=brighten` | 0.0 | - | refused: ValueError: Unknown preset 'brighten'. Available: blue_black_ink, h_dab |
| `cctv/event_optflow.jpg` | `invert=True` | 22.1 | [362, 640] uint8 mean 179.07 | ok |
| `cctv/event_tamper.jpg` | `defaults` | 22.4 | [362, 640] uint8 mean 120.68 | ok |
| `cctv/event_tamper.jpg` | `preset=blue_black_ink` | 22.2 | [362, 640] uint8 mean 243.36 | ok |
| `cctv/event_tamper.jpg` | `preset=brighten` | 0.0 | - | refused: ValueError: Unknown preset 'brighten'. Available: blue_black_ink, h_dab |
| `cctv/event_tamper.jpg` | `invert=True` | 22.4 | [362, 640] uint8 mean 134.32 | ok |
| `cctv/flattest.jpg` | `defaults` | 22.5 | [362, 640] uint8 mean 71.29 | ok |
| `cctv/flattest.jpg` | `preset=blue_black_ink` | 22.5 | [362, 640] uint8 mean 234.1 | ok |
| `cctv/flattest.jpg` | `preset=brighten` | 0.0 | - | refused: ValueError: Unknown preset 'brighten'. Available: blue_black_ink, h_dab |
| `cctv/flattest.jpg` | `invert=True` | 22.5 | [362, 640] uint8 mean 183.71 | ok |
| `cctv/most_blown.jpg` | `defaults` | 23.3 | [362, 640] uint8 mean 92.87 | ok |
| `cctv/most_blown.jpg` | `preset=blue_black_ink` | 23.4 | [362, 640] uint8 mean 244.59 | ok |
...
| `cctv/sharpest.jpg` | `defaults` | 23.2 | [362, 640] uint8 mean 87.73 | ok |
| `cctv/sharpest.jpg` | `preset=blue_black_ink` | 24.4 | [362, 640] uint8 mean 240.91 | ok |
| `cctv/sharpest.jpg` | `preset=brighten` | 0.0 | - | refused: ValueError: Unknown preset 'brighten'. Available: blue_black_ink, h_dab |
| `cctv/sharpest.jpg` | `invert=True` | 24.0 | [362, 640] uint8 mean 167.27 | ok |
| `cctv/softest.jpg` | `defaults` | 26.4 | [362, 640] uint8 mean 75.85 | ok |
| `cctv/softest.jpg` | `preset=blue_black_ink` | 22.1 | [362, 640] uint8 mean 241.01 | ok |
| `cctv/softest.jpg` | `preset=brighten` | 0.0 | - | refused: ValueError: Unknown preset 'brighten'. Available: blue_black_ink, h_dab |
| `cctv/softest.jpg` | `invert=True` | 22.6 | [362, 640] uint8 mean 179.15 | ok |
| `reference/lena.png` | `defaults` | 25.1 | [512, 512] uint8 mean 117.22 | ok |
| `reference/lena.png` | `preset=blue_black_ink` | 25.4 | [512, 512] uint8 mean 254.31 | ok |
| `reference/lena.png` | `preset=brighten` | 0.0 | - | refused: ValueError: Unknown preset 'brighten'. Available: blue_black_ink, h_dab |
| `reference/lena.png` | `invert=True` | 25.7 | [512, 512] uint8 mean 137.78 | ok |
