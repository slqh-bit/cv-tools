...
| `cctv/darkest.jpg` | `defaults` | 2.4 | [362, 640, 3] uint8 mean 110.93 | output identical to input |
| `cctv/event_fall.jpg` | `defaults` | 2.6 | [362, 640, 3] uint8 mean 125.51 | output identical to input |
| `cctv/event_optflow.jpg` | `defaults` | 2.7 | [362, 640, 3] uint8 mean 125.42 | output identical to input |
| `cctv/event_tamper.jpg` | `defaults` | 2.4 | [362, 640, 3] uint8 mean 160.62 | output identical to input |
...
| `cctv/sharpest.jpg` | `defaults` | 2.9 | [362, 640, 3] uint8 mean 131.76 | output identical to input |
| `cctv/softest.jpg` | `defaults` | 3.1 | [362, 640, 3] uint8 mean 125.38 | output identical to input |
