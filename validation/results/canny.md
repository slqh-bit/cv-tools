...
|---|---|---|---|---|
| `cctv/brightest.jpg` | `defaults` | 0.7 | [362, 640] uint8 mean 11.4 | ok |
| `cctv/brightest.jpg` | `low_threshold=0` | 1.2 | [362, 640] uint8 mean 25.51 | ok |
...
| `cctv/brightest.jpg` | `l2_gradient=True` | 0.4 | [362, 640] uint8 mean 9.26 | ok |
| `cctv/brightest.jpg` | `blur_sigma=0.0` | 0.4 | [362, 640] uint8 mean 11.4 | ok |
| `cctv/brightest.jpg` | `blur_sigma=10.0` | 2.3 | [362, 640] uint8 mean 0.0 | flat output - every pixel is 0 |
| `cctv/darkest.jpg` | `defaults` | 0.6 | [362, 640] uint8 mean 16.69 | ok |
| `cctv/darkest.jpg` | `low_threshold=0` | 0.8 | [362, 640] uint8 mean 30.11 | ok |
...
| `cctv/darkest.jpg` | `high_threshold=255` | 0.4 | [362, 640] uint8 mean 15.04 | ok |
| `cctv/darkest.jpg` | `l2_gradient=True` | 0.4 | [362, 640] uint8 mean 13.6 | ok |
| `cctv/darkest.jpg` | `blur_sigma=0.0` | 0.4 | [362, 640] uint8 mean 16.69 | ok |
| `cctv/darkest.jpg` | `blur_sigma=10.0` | 2.9 | [362, 640] uint8 mean 0.0 | flat output - every pixel is 0 |
| `cctv/event_fall.jpg` | `defaults` | 0.7 | [362, 640] uint8 mean 28.93 | ok |
...
| `cctv/event_fall.jpg` | `high_threshold=255` | 0.5 | [362, 640] uint8 mean 26.88 | ok |
| `cctv/event_fall.jpg` | `l2_gradient=True` | 0.6 | [362, 640] uint8 mean 25.01 | ok |
| `cctv/event_fall.jpg` | `blur_sigma=0.0` | 0.7 | [362, 640] uint8 mean 28.93 | ok |
| `cctv/event_fall.jpg` | `blur_sigma=10.0` | 2.3 | [362, 640] uint8 mean 0.0 | flat output - every pixel is 0 |
| `cctv/event_optflow.jpg` | `defaults` | 0.5 | [362, 640] uint8 mean 15.28 | ok |
...
| `cctv/event_optflow.jpg` | `high_threshold=255` | 0.4 | [362, 640] uint8 mean 13.76 | ok |
| `cctv/event_optflow.jpg` | `l2_gradient=True` | 0.5 | [362, 640] uint8 mean 13.23 | ok |
| `cctv/event_optflow.jpg` | `blur_sigma=0.0` | 0.4 | [362, 640] uint8 mean 15.28 | ok |
| `cctv/event_optflow.jpg` | `blur_sigma=10.0` | 2.2 | [362, 640] uint8 mean 0.0 | flat output - every pixel is 0 |
| `cctv/event_tamper.jpg` | `defaults` | 0.4 | [362, 640] uint8 mean 10.92 | ok |
| `cctv/event_tamper.jpg` | `low_threshold=0` | 1.0 | [362, 640] uint8 mean 24.08 | ok |
...
| `cctv/event_tamper.jpg` | `l2_gradient=True` | 0.5 | [362, 640] uint8 mean 8.99 | ok |
| `cctv/event_tamper.jpg` | `blur_sigma=0.0` | 0.4 | [362, 640] uint8 mean 10.92 | ok |
| `cctv/event_tamper.jpg` | `blur_sigma=10.0` | 2.2 | [362, 640] uint8 mean 0.0 | flat output - every pixel is 0 |
| `cctv/flattest.jpg` | `defaults` | 0.7 | [362, 640] uint8 mean 14.37 | ok |
...
| `cctv/flattest.jpg` | `high_threshold=255` | 0.4 | [362, 640] uint8 mean 13.49 | ok |
| `cctv/flattest.jpg` | `l2_gradient=True` | 0.4 | [362, 640] uint8 mean 12.33 | ok |
| `cctv/flattest.jpg` | `blur_sigma=0.0` | 0.4 | [362, 640] uint8 mean 14.37 | ok |
| `cctv/flattest.jpg` | `blur_sigma=10.0` | 2.8 | [362, 640] uint8 mean 0.0 | flat output - every pixel is 0 |
| `cctv/most_blown.jpg` | `defaults` | 0.5 | [362, 640] uint8 mean 17.34 | ok |
| `cctv/most_blown.jpg` | `low_threshold=0` | 0.8 | [362, 640] uint8 mean 27.69 | ok |
...
| `cctv/most_blown.jpg` | `high_threshold=255` | 0.5 | [362, 640] uint8 mean 15.63 | ok |
| `cctv/most_blown.jpg` | `l2_gradient=True` | 0.5 | [362, 640] uint8 mean 14.17 | ok |
| `cctv/most_blown.jpg` | `blur_sigma=0.0` | 0.5 | [362, 640] uint8 mean 17.34 | ok |
| `cctv/most_blown.jpg` | `blur_sigma=10.0` | 2.2 | [362, 640] uint8 mean 0.0 | flat output - every pixel is 0 |
| `cctv/sharpest.jpg` | `defaults` | 0.7 | [362, 640] uint8 mean 30.53 | ok |
| `cctv/sharpest.jpg` | `low_threshold=0` | 1.1 | [362, 640] uint8 mean 45.65 | ok |
...
| `cctv/sharpest.jpg` | `high_threshold=255` | 0.6 | [362, 640] uint8 mean 28.21 | ok |
| `cctv/sharpest.jpg` | `l2_gradient=True` | 0.7 | [362, 640] uint8 mean 26.53 | ok |
| `cctv/sharpest.jpg` | `blur_sigma=0.0` | 0.5 | [362, 640] uint8 mean 30.53 | ok |
| `cctv/sharpest.jpg` | `blur_sigma=10.0` | 2.2 | [362, 640] uint8 mean 0.0 | flat output - every pixel is 0 |
| `cctv/softest.jpg` | `defaults` | 0.4 | [362, 640] uint8 mean 9.08 | ok |
...
| `cctv/softest.jpg` | `high_threshold=255` | 0.3 | [362, 640] uint8 mean 8.2 | ok |
| `cctv/softest.jpg` | `l2_gradient=True` | 0.4 | [362, 640] uint8 mean 7.87 | ok |
| `cctv/softest.jpg` | `blur_sigma=0.0` | 0.3 | [362, 640] uint8 mean 9.08 | ok |
| `cctv/softest.jpg` | `blur_sigma=10.0` | 2.2 | [362, 640] uint8 mean 0.0 | flat output - every pixel is 0 |
