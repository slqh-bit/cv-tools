...
| `src/core/report.py:72` | Le rapport écrit nom, module, horodatage et paramètres, mais aucune description — alors que chaque entrée de `FILTER_REGISTRY` en porte une |
| `src/gui/widgets.py:92` | `VIEW_MODES` n'offre pas de vue différence |
